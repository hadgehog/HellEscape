// HellEscape.cpp : Defines the entry point for the application.
//
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_HELLESCAPE, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_HELLESCAPE));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_HELLESCAPE);
